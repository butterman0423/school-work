...
public class RegisterService extends Service {
    ...
    public int onStartCommand(@NonNull Intent intent, int flags, final int startId) {
        ...
        Notification.Action.Builder cancelAction =
                new Notification.Action.Builder(icon, getString(R.string.register_cancel_button_label), pendingCancelIntent);

        notificationBuilder.addAction(cancelAction.build());
                ...
                mainLoop.post(() -> {
                    ...
                    if (registerResponse != null && !(registerResponse instanceof ErrorResponse)) {
                        ...
                        notificationManager.notify(notificationId,
                                createNotificationBuilder()
                                        .setContentText(getString(R.string.register_notification_title))
                                        .setContentText(getString(R.string.registered_notification_message))
                                        .setTicker(getString(R.string.registered_ticker_text))
                                        .build()
                        );
                        ...
                        notificationManager.notify(notificationId,
                                createNotificationBuilder()
                                        ...
                                        .setTicker(getString(R.string.register_failed_ticker_text))
                                        .build()
                        );
