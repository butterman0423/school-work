...
public class ChatroomsFragment extends Fragment implements View.OnClickListener, TextAdapter.OnItemClickListener<Chatroom> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.chatroomsAdapter = new TextAdapter<>(chatroomList, this);
        chatroomList.setAdapter(this.chatroomsAdapter);
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        this.chatroomViewModel = new ViewModelProvider(this).get(ChatroomViewModel.class);

        LiveData<List<Chatroom>> liveChats = this.chatroomViewModel.fetchAllChatrooms();
        liveChats.observe(getViewLifecycleOwner(), chats -> {
            this.chatroomsAdapter.notifyItemRangeRemoved(0, this.chatroomsAdapter.getItemCount());
            this.chatroomsAdapter.setDataset(chats);
            this.chatroomsAdapter.notifyItemRangeChanged(0, this.chatroomsAdapter.getItemCount());
        });
    }
    ...
    public void onClick(View v) {
        ...
        listener.addChatroom( this.chatroomName.getText().toString() );
