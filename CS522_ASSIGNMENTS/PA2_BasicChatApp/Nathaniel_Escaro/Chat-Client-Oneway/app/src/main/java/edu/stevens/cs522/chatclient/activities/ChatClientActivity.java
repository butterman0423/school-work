...
//  private DatagramSocket clientSocket;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		this.destinationAddr = (EditText) findViewById(R.id.destination_addr);
		this.chatName = (EditText) findViewById(R.id.chat_name);
		this.messageText = (EditText) findViewById(R.id.message_text);

		// Set destinationAddr text to be app_port
		String defPort = Integer.toString( getResources().getInteger(R.integer.app_port) );
		this.destinationAddr.setText(defPort);

		Button nextBtn = (Button) findViewById(R.id.send_button);
	...
	public void onClick(View v) {
		try {
			...
			destAddr = this.destinationAddr.getText().toString();
			clientName = this.chatName.getText().toString();
			text = this.messageText.getText().toString();
