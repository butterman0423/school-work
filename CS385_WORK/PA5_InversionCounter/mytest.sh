...
# Version : 1.0
# Date    : 10/31/2023
# Description : Test script for inversioncounter.cpp
...
run_test_with_args_and_input "slow" "2 3 4" "Enter sequence of integers, each followed by a space: Number of inversions (slow): 0"
run_test_with_args_and_input "slow" "4 3 2" "Enter sequence of integers, each followed by a space: Number of inversions (slow): 3"
run_test_with_args_and_input "slow" "1 3 2 1 1 8 5" "Enter sequence of integers, each followed by a space: Number of inversions (slow): 6"
run_test_with_args_and_input "slow" "12 58 102 73 2 10" "Enter sequence of integers, each followed by a space: Number of inversions (slow): 9"
run_test_with_args_and_input "slow" "1 1 1 1 1 1" "Enter sequence of integers, each followed by a space: Number of inversions (slow): 0"
run_test_with_args_and_input "slow" "5 6 7 8 9 1 2 2 8 10" "Enter sequence of integers, each followed by a space: Number of inversions (slow): 16"
run_test_with_args_and_input "slow" "200 100 400 300 500 250" "Enter sequence of integers, each followed by a space: Number of inversions (slow): 5"
run_test_with_args_and_input "slow" "$(seq -s " " 1 100000)" "Enter sequence of integers, each followed by a space: Number of inversions (slow): 0"
run_test_with_args_and_input "slow" "$(seq -s " " 100000 -1 1)" "Enter sequence of integers, each followed by a space: Number of inversions (slow): 4999950000"
...
run_test_with_args_and_input "" "2 5 12" "Enter sequence of integers, each followed by a space: Number of inversions (fast): 0"
run_test_with_args_and_input "" "4 3 2 1" "Enter sequence of integers, each followed by a space: Number of inversions (fast): 6"
run_test_with_args_and_input "" "1 3 2 1 1 8 5" "Enter sequence of integers, each followed by a space: Number of inversions (fast): 6"
run_test_with_args_and_input "" "12 58 102 73 2 10" "Enter sequence of integers, each followed by a space: Number of inversions (fast): 9"
run_test_with_args_and_input "" "1 1 1 1 1 1" "Enter sequence of integers, each followed by a space: Number of inversions (fast): 0"
run_test_with_args_and_input "" "5 6 7 8 9 1 2 2 8 10" "Enter sequence of integers, each followed by a space: Number of inversions (fast): 16"
run_test_with_args_and_input "" "200 100 400 300 500 250" "Enter sequence of integers, each followed by a space: Number of inversions (fast): 5"
run_test_with_args_and_input "" "$(seq -s " " 1 100000)" "Enter sequence of integers, each followed by a space: Number of inversions (fast): 0"
run_test_with_args_and_input "" "$(seq -s " " 100000 -1 1)" "Enter sequence of integers, each followed by a space: Number of inversions (fast): 4999950000"
